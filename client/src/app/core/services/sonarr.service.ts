...
export class SonarrService {
  ...
  saveConfig(host: string, apiKey: string, externalUrl?: string, maxEpisodeSize?: number): Observable<{ success: boolean; config: SonarrConfig }> {
  ...
  updateConfig(maxEpisodeSize?: number, externalUrl?: string): Observable<{ success: boolean; config: SonarrConfig }> {
